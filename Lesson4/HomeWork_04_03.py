...
# Определяем количество сериалов с жанром "фантастика" из словаря shows
# Определяем сумму рейтингов сериалов с жанром "фантастика" из словаря ratings
for key, value in shows.items():
    if value == 'фантастика':
        sum_rating += ratings[key]
        counter += 1
print('Средний рейтинг сериала жанра "фантастика":', sum_rating / counter)
